...
"""Stable alias for :mod:`esp_morpheus.sdk.group`, where the code now lives.
...
from esp_morpheus.sdk.group import *  # noqa: F401,F403
import esp_morpheus.sdk.group as _target
