...
1. [Quick start](https://docs.neo.rainmaker.espressif.com/docs/get-started?path=public): We host a public ESP RainMaker Neo deployment for facilitating evaluations and for hobbyists use. You don't need to do any cloud setup at all. Check out the detailed documentation [here](https://docs.neo.rainmaker.espressif.com/docs/get-started?path=public) for more information.
2. [Deploy in your own account](https://docs.neo.rainmaker.espressif.com/docs/get-started?path=packaged): Run the pre-built ESP RainMaker Neo cloud in your own AWS account. Check out the detailed documentation [here](https://docs.neo.rainmaker.espressif.com/docs/get-started?path=packaged) for more information.
3. [Built From Source](BUILD.md) (Built-From-Source ESP RainMaker Neo): Build, modify and deploy the cloud yourself. This repository holds the cloud backend, its infrastructure, the admin dashboard, docs, and the test tooling. See **[BUILD.md](BUILD.md)** for the full guide.
