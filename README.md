...
Use the public ESP RainMaker Neo deployment — no cloud setup at all. Check out the detailed documentation [here](https://docs.neo.rainmaker.espressif.com/docs/get-started?path=packaged) for more information.

### Option 2: Packaged ESP RainMaker Neo

Run the pre-built ESP RainMaker Neo cloud in your own AWS account. Check out the detailed documentation [here](https://docs.neo.rainmaker.espressif.com/docs/get-started?path=from-source) for more information.
