...
"""Stable alias for :mod:`esp_morpheus.sdk.config_sources`, where the code now lives.
...
from esp_morpheus.sdk.config_sources import *  # noqa: F401,F403
import esp_morpheus.sdk.config_sources as _target
