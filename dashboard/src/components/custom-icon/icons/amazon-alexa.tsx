...
export function AmazonAlexaIcon({ size = 18 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
      viewBox="0 0 122.82 122.88"
      fill="none"
